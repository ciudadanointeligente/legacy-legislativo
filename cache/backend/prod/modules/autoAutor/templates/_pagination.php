<div class="sf_admin_pagination">
  <a href="<?php echo url_for('@autor') ?>?page=1">
  ...
  <a href="<?php echo url_for('@autor') ?>?page=<?php echo $pager->getPreviousPage() ?>">
  ...
  <?php foreach ($pager->getLinks() as $page): ?>
    <?php if ($page == $pager->getPage()): ?>
      <?php echo $page ?>
    <?php else: ?>
      <a href="<?php echo url_for('@autor') ?>?page=<?php echo $page ?>"><?php echo $page ?></a>
    <?php endif; ?>
  <?php endforeach; ?>

  <a href="<?php echo url_for('@autor') ?>?page=<?php echo $pager->getNextPage() ?>">
  ...
  <a href="<?php echo url_for('@autor') ?>?page=<?php echo $pager->getLastPage() ?>">
