...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/votainteligente/legislativo/log/prefrontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/votainteligente/legislativo/cache/prefrontend/dev/i18n',
  'lifetime' => 31556926,
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/votainteligente/legislativo/cache/prefrontend/dev/template',
  'lifetime' => 86400,
