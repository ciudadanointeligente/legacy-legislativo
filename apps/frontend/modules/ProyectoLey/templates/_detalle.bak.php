...
<?php if ($this_proyecto->getIdProyectoLey() != null): ?>
  <table class="tb_proyecto_detalle">
    ...
    <tr><td colspan="4">
      <h2>Detalles:</h2>
      <p><a href="http://sil.senado.cl/cgi-bin/sil_tramitacion.pl?<?php echo $this_proyecto->getNroInterno() ?>" target="_blank">Tramitación</a> | 
      <a href="http://sil.senado.cl/cgi-bin/sil_oficios.pl?<?php echo $this_proyecto->getNroInterno() ?>" target="_blank">Oficios</a> | 
      <a href="http://sil.senado.cl/cgi-bin/sil_indicaciones.pl?<?php echo $this_proyecto->getNroInterno() ?>" target="_blank">Indicaciones</a> |
      <a href="http://sil.senado.cl/cgi-bin/sil_urgencias.pl?<?php echo $this_proyecto->getNroInterno() ?>" target="_blank">Urgencias</a></p>
    </td></tr>
