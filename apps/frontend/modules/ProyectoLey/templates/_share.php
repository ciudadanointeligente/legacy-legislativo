<div class="sexy-bookmarks" style="padding:0px 0 20px 0px !important; display:block !important; clear:both !important; height:29px;" id="sexy-bookmarks">
  ...
  <li class="sexy-twittley"><a href="http://twitter.com/?status=<?php echo urlencode('Sigue el proyecto: '.substr($titulo,0,92)); echo (strlen($titulo)>92) ? '... ' : ' '; echo file_get_contents('http://tinyurl.com/api-create.php?url='.urlencode($link)) ?>" target="_blank" rel="" title="Compártelo en Twitter"> </a></li>
