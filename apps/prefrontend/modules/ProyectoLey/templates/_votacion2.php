    ...
    <div class="voto_box_1">
      <table id="tb_voto_1">
        <tbody>
          <tr>
            <td>
              <strong>Votación <?php echo ($votacion->getTipo()=='ambas') ? 'general y particular' : $votacion->getTipo(); ?></strong>
              <?php if ($nota): ?>
          ...
          <tr>
            <td><?php if ($votacion->getTipo() == 'ambas') echo 'Conveniencia de legislar sobre el proyecto y todos sus artículos.'; else if ($votacion->getTipo() == 'general') echo 'Conveniencia de legislar sobre el proyecto'; else echo $votacion->getArticulo(); ?>
            </td>
          </tr>
        </tbody>
      </table>
