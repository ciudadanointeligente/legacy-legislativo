 ...
 */
abstract class BaseVotacionComisionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('votacion_comision_filters[%s]');
  ...
  public function addParlamentarioListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query->leftJoin('r.VotacionComisionParlamentario VotacionComisionParlamentario')
          ->andWhereIn('VotacionComisionParlamentario.id_parlamentario', $values);
  }
