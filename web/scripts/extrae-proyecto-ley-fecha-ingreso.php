            ...
            else
            {
                ...
                ajax.onreadystatechange=function() {
                    if (ajax.readyState==1) {
                        divResultado.innerHTML = 'Cargando informaci&oacute;n, por favor espere...<br /><img src="imgs/loading.gif" border="0" />'
                    }
...
<table>
    <tr>
        <td align="left" class="TITULAR">
          ...
          <input type="button" class="TEXTtema" value=":: Continuar proceso ::" name="continuar" onclick="rld();" />
